...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
    ...
    try {
        switch ($_GET['q']) {
            case 'all':
                ...
                header('http://' . $_SERVER['HTTP_HOST'] . '/THYP_17-18/lydia-leb/grid.html');
                break;
            case 'info':
    ...
    //
} else {//s'il est nest pas connecté
    $redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/THYP_17-18/lydia-leb/agenda/callback.php';
