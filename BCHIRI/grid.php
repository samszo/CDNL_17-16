...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
	...
	//
//$_GET['q'] = 'present';
	//$_GET['id'] = 'leilabchiriboujnah@gmail.com';
	/*try {
	...
	$redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/THYP_17-18/BCHIRI/grid/callback.php';
...
$(function () { w2utils.lock($("#grid"),"loading...",true);
	$.getJSON("/THYP_17-18/BCHIRI/agenda/index.php?q=all",
//$.getJSON("/THYP_17-18/BCHIRI/agenda/index.php?q=all",
		function(data){
      console.log(data);
...
var url="/THYP_17-18/BCHIRI/agenda/index.php?q=info&id="+EventId;
console.log(url);
  $.getJSON(url,
...
inc++;
    ...
    var frmEvent  = $().w2form({
       ...
       actions: {
           ...
           var lien="http://localhost/THYP_17-18/BCHIRI/agenda/index.php?q=presentDate&id="+EventId+"&desc="+description_ev+"&date="+debut_ev+"&dateF="+fin_ev;
            $.ajax({
             url: lien,
    ...
    w2popup.open({
        ...
        onOpen  : function (event) {
           ...
           if(w2ui['lyEvent'])w2ui['lyEvent'].destroy();
                     ...
                     w2ui['lyEvent'].load('bottom', "http://localhost/THYP_17-18/BCHIRI/palette/1.svg"
                         , 'pop-in', function () {
