...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
    ...
    $redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/THYP_17-18/TheSimplone0/agenda/callbackCalender.php'; 
...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
	...
	$redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/THYP_17-18/TheSimpleone0/agenda/callbackCalender.php';
	header('Location: ' . filter_var($redirect_uri, FILTER_SANITIZE_URL));
}
