...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
	...
	$redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/THYP_17-18/rabiata/trombinoscope/callback.php';
...
function validerPresence(){
 ...
 var lien="http://localhost/THYP_17-18/rabiata/agenda/index.php?desc=Presence&email[]="+h;
 $.ajax({
  url: lien,
