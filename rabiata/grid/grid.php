...
//$_GET['q'] = 'present';
	...
	$redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/THYP_17-18/rabiata/grid/callback.php';
...
console.log(url);
  $.getJSON(url,
//  $.getJSON("/THYP_17-18/rabiata/agenda/index.php?q=info&id="+EventId,
//$.getJSON("/THYP_17-18/rabiata/agenda/index.php?q=all",
  function(data2){
      console.log(data2);
