...
if(isset($_GET['q'])){
    try {
        ...
        echo "<br><br>";
        echo "<center>";
        echo "<a href='http://" . $_SERVER['HTTP_HOST'] . "/THYP_17-18/kahina92/trombinoscope/index.php?out=1'>se deconnecter</a>";
        echo "</center>";
	...
	$redirect_uri = 'http://' . $_SERVER['HTTP_HOST'] . '/THYP_17-18/kahina92/trombinoscope/callback.php';
